...
export class AppComponent {
  ...
  constructor(){
    this.restaurants = [
      new Restaurant("Boxer Ramer", "Asian", "1234 Example st", 2, [0],0),
      new Restaurant("Le Pigeon", "French", "231 Fake st", 4, [0], 1),
      new Restaurant("Piazza Italia", "Italian", "1232 Marshall st", 3, [0], 2)
    ];
  }
